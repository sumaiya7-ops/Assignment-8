...
import { FcGoogle } from "react-icons/fc"; // রঙিন গুগল আইকন
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-80px)] bg-indigo-50/30 px-4 py-10">
      <div className="card w-full max-w-[450px] shadow-xl bg-white p-6 md:p-10 border border-indigo-100 rounded-2xl">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-2 text-cyan-900">Welcome Back</h2>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="form-control w-full">
            ...
            <input 
              ...
              className="input input-bordered focus:outline-indigo-500 w-full bg-indigo-50/20" 
              required 
          ...
          <div className="form-control w-full relative">
            ...
            <div className="relative w-full">
              <input 
                ...
                placeholder="••••••••" 
                className="input input-bordered focus:outline-indigo-500 w-full bg-indigo-50/20 pr-12" 
                required 
          ...
          <button 
            type="submit" 
            className={`btn btn-primary w-full mt-2 text-white font-bold text-lg normal-case ${loading ? 'loading' : ''}`}
            disabled={loading}
          >
        ...
        <button 
          ...
          className="btn btn-outline w-full border-gray-300 font-medium normal-case flex items-center justify-center gap-2 hover:bg-gray-50 mb-2 rounded-lg"
        >
          <FcGoogle size={24} /> 
